...
def load_model():
    try:
        ...
        st.error("⚠️ Model file 'news.pkl' not found. Please ensure the file is in the same directory.")
        return None
            ...
            with st.spinner('🔄 Analyzing article...'):
                try:
                    ...
                    if res == 1:
                        ...
                        st.warning("⚠️ This article doesn't clearly fit into any of the predefined categories.")
                    ...
                    if title or des:
                        with st.expander("📄 View Article Preview"):
                            ...
                            st.markdown(f"**Description:** {des[:300]}{'...' if len(des) > 300 else ''}")
